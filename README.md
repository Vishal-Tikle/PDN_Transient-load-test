...
# 3. Configure Electronic Load (Keithley 2380)
	# Turn on remote mode
	load.write(‘SYST:REM’)
...
Reference:
1. https://www.pyvisa.com/docs/scpi-commands-python
2. https://iotexpert.com/pyvisa-first-use/
3. https://download.tek.com/manual/2230G-900-01A_Jun_2018_User.pdf
4. https://download.tek.com/manual/2380-120-60-900-01_A_Nov_2015.pdf
5. https://yout.be/TLUTCDbt52I?si=2d2F0aNQ9KqSg2R0
6. https://assets.testequity.com/te1/Documents/pdf/keithley/2220-2230-ds.pdf
